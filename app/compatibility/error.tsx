...
export default function CompatibilityError({
  ...
  useEffect(() => {
    console.error("Compatibility Page Error:", error)
  }, [error])
  ...
  return (
    <div className="container mx-auto py-20 px-4 text-center min-h-[calc(100vh-10rem)] flex flex-col items-center justify-center">
      ...
      <h2 className="text-3xl font-bold text-red-400 mb-3">Error Loading Compatibility List</h2>
      <p className="text-slate-300 mb-6 max-w-md">
        We couldn't fetch the device compatibility information. Please try refreshing.
      </p>
